...
import avatar from "../../public/assetes/avatardefault.jpg";
...
const Header = ({ activeItem, open, setOpen, route, setRoute }: Props) => {
  ...
  return (
    <div className="w-full relative">
      <div
        className={`${active
          ? "fixed top-0 left-0 w-full h-[80px] z-[80] bg-white border-b border-gray-200 shadow-xl transition duration-500 dark:bg-opacity-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-black dark:border-gray-700"
          : "w-full h-[80px] z-[80] bg-white border-b border-gray-200 dark:bg-transparent dark:border-[#ffffff1c] dark:shadow"
          }`}
      >
